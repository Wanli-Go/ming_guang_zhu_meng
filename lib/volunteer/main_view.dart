    ...
    return Consumer<BottomNavNotifier>(builder: (context, bottomNotifier, c) {
      ...
      return Scaffold(
                        ...
                        child: Row(
                          children: <Widget>[
                            Expanded(
                              ...
                              child: TextField(
                                onSubmitted: (value) => model.searchClicked(
                                    context, value, articlesModel),
        ...
        body: IndexedStack(
          ...
          children: [
            Consumer<TaskInfoUpdateNotifier>(builder: (context, notifier, c) {
              if (debug != false) {
                keyForRefreshTask += 1;
              }
              print(debug);
              return TaskList(
                key: GlobalObjectKey(keyForRefreshTask),
              );
            }),
            Consumer<TaskInfoUpdateNotifier>(builder: (context, notifier, c) {
              if (debug != false) {
              ...
              return HomePageBody(
                  key: GlobalObjectKey(keyForRefreshMain),
                  bottomNotifier: bottomNotifier);
            }),
            CommunityBody(
              model: articlesModel,
            ),
