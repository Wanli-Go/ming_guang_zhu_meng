...
import 'model/points_mall_model.dart';
            ...
            child: Row(
              children: categories
                  ...
                  .map((entry) => Padding(
                        ...
                        child: ChoiceChip(
                          backgroundColor: Colors.pink.shade100, // 调整为淡粉色背景
                          selectedColor: Colors.pink.shade300, // 选择时更深的粉色
                          label: Text(entry.value),
                          selected: selectedCategory == entry.key,
                          onSelected: (bool selected) {
                            setState(() {
                              selectedCategory = selected ? entry.key : 0;
